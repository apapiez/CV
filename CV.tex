...
\begin{entrylist}
	...
	{Northumbria University}
	{\emph{Classification:} First Class Honours\\
		\vspace{-0.4cm}\rule[0.3cm]{0.8\textwidth}{0.4pt}\\ 
...
\section{Interests}
I am a capable programmer and enjoy the creative thinking involved in solving technical problems; in conjunction with amateur DIY, I enjoy producing software and hardware to tackle real world problems.
\\
